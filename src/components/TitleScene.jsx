...
const TitleScene = ({ onStart }) => {
  // สร้าง state เช็คว่ารูปโหลดเสร็จหรือยัง (เผื่อกรณีเน็ตช้าจริงๆ)
    ...
    <div className="text-center flex flex-col items-center justify-center py-4 md:py-12 w-full animate-[zoomIn_0.3s_ease-out]">
      <div className="animate-float mb-6 md:mb-10">
        <div className="relative inline-block mb-4">
          {/* ส่วนแสดง Logo: ใช้ opacity transition เพื่อความนวล */}
          <div
            className={`
            text-7xl md:text-9xl mb-4 text-[#2f3542] drop-shadow-lg transition-opacity duration-300
